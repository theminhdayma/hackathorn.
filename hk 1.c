        ...
        switch (choice) {
            ...
            case 3:
			    ...
			    if (foundIndex != -1) {
			        ...
			        printf("Nhap thong tin moi cho contact:\n");
			        printf("ID: ");
			        scanf("%d", &updatedContact.id);
			        printf("Ten: ");
			        ...
			        printf("Trang Thai: ");
			        scanf("%d", &updatedContact.status);
			
			        contactList[foundIndex] = updatedContact;
			        printf("Thong tin cua contact da duoc cap nhat.\n");
			    } else {
